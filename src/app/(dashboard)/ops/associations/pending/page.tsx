 ...
 *
 * Same posture as the sibling ops/associations/new page: real enforcement
 * is server-side (requireRole on both API routes below); this page's own
  ...
  if (session?.user?.role !== 'athlasx_ops') {
    return (
      <div className="glass-card p-8 flex flex-col items-center text-center gap-2">
        ...
        <p className="text-xs text-zinc-600">Approving an association grants it real access — restricted to the Ops team.</p>
      </div>
    )
  }
