          ...
          {job.status === 'pending_review' && action === 'idle' && (
            <div className="flex items-center gap-3 pt-2">
              ...
              <button
                ...
                disabled={deciding}
                className="flex-1 py-2.5 rounded-xl bg-ax-accent hover:bg-ax-accentBright text-[#1a0e02] text-sm font-bold transition-colors disabled:opacity-50"
              >
        ...
        <div className="grid sm:grid-cols-3 gap-3">
          ...
          <div className="p-4 rounded-2xl border border-white/[0.06] bg-white/[0.02] space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 py-2 rounded-xl bg-ax-accent/80 hover:bg-ax-accent text-[#1a0e02] text-xs font-bold transition-colors disabled:opacity-60"
            >
