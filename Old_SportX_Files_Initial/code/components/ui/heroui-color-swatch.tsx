...
function colorObject(color: string): ColorSwatchRenderProps["color"] {
  return { value: color, toString: () => hexToRgba(color) };
}

function ColorSwatch({
  className, color, colorName, shape = "circle", size = "md", style, render,
...
function ColorSwatchStyles() {
  return (
    <style>{`
      ...
      .color-swatch--xs { width: 16px; height: 16px; }
