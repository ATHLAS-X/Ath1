...
export async function GET(req: NextRequest) {
  ...
  /* requireActiveScout() also admits admin/athlasx_admin, who bypass the
     visibility model entirely per lib/authz.ts's canViewPlayerProfile —
     scouts only ever see 'Scout Visible' players. This query previously had
     no visibility filter at all, regardless of caller role. */
